...
drop = OptionMenu(opt_frame,clicked,*options)
drop.grid(row=0,column = 1)

def next():
   
   #Note Label 
   note_label = Label(main_win,text = "Note : Give iunput in the respective SI Units.")
   ...
   def clear_frame():
      for widgets in next_frame.winfo_children():
         widgets.destroy()
   ...
   if selected == "Temprature" :
      def temprature():
         ...
         def temp_convert():
            #Checking the input
            if (temp_SI_unit_K.get()).isnumeric() == False:
   ...
   if selected == "Pressure" :
      def pressure():
         ...
         def press_convert():
            #Checking the input
            if (press_SI_unit_Pa.get()).isnumeric() == False:
               messagebox.showerror("Input Error","Plese give a numerical input.")
               return None
   ...
   if selected == "Length" :
      def length():
         ...
         def len_convert():
            #Checking the input
            if (len_SI_unit_m.get()).isnumeric() == False:
               messagebox.showerror("Input Error","Plese give a numerical input.")
               return None
...
#Velocity
   if selected == "Velocity" :
      def Velocity():
         ...
         def vel_convert():
            #Checking the input
            if (vel_SI_unit_mps.get()).isnumeric() == False:
               messagebox.showerror("Input Error","Plese give a numerical input.")
               return None
...
#Force
   if selected == "Force" :
      def Force():
         ...
         def for_convert():
            #Checking the input
            if (f_SI_unit_n.get()).isnumeric() == False:
               messagebox.showerror("Input Error","Plese give a numerical input.")
               return None
...
# OK Button
proceed_button = Button(main_win,text = "Proceed",command = next)
